...
import senac.ads.pi3.gerenciador_produtos.ui.*;
import java.text.NumberFormat;
import java.util.Locale;
import javax.swing.JOptionPane;
import senac.ads.pi3.gerenciador_produtos.Principal;
...
public class TelaEditarProduto extends javax.swing.JInternalFrame {
    ...
    public void setProduto(Produto produto) {
        ...
        txtPrecoCompra.setText(NumberFormat.getCurrencyInstance().format(produto.getPrecoCompra()));
        txtPrecoVenda.setText(NumberFormat.getCurrencyInstance().format(produto.getPrecoVenda()));
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        try {            
            ...
            ServicoProduto.atualizaProduto(produto);
            if (this.getDesktopPane().getTopLevelAncestor() instanceof Principal) {
                Principal principal = (Principal) this.getDesktopPane().getTopLevelAncestor();
                if (principal != null) {
